...
action="http://localhost:8091/OurDoctor/Register1">
    ...
    <h3>Already this phone number is registered..Enter the new phone Number!!</h3>
    <h4>Try Again</h4>
   ...
   <b>Confirm Password</b> <input type="password" placeholder="Repeat Password" name="cpw"required>
    <hr>
